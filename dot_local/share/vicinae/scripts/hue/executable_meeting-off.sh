...
# @vicinae.title Hue Couch Meeting: Off
# @vicinae.mode silent
# @vicinae.packageName Hue
# @vicinae.icon 🌑
# @vicinae.keywords ["meeting off", "hue"]
# @vicinae.description Recall the "Off" scene for Couch Meeting.

exec "$HOME/.local/bin/hue" meeting off
