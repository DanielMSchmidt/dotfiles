...
# @vicinae.title Hue All Rooms: Bright
# @vicinae.mode silent
# @vicinae.packageName Hue
# @vicinae.icon 🔆
# @vicinae.keywords ["all bright", "hue"]
# @vicinae.description Recall the "Bright" scene for All Rooms.

exec "$HOME/.local/bin/hue" all bright
