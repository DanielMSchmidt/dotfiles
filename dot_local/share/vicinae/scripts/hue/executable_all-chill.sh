...
# @vicinae.title Hue All Rooms: Chill
# @vicinae.mode silent
# @vicinae.packageName Hue
# @vicinae.icon 🌙
# @vicinae.keywords ["all chill", "hue"]
# @vicinae.description Recall the "Chill" scene for All Rooms.

exec "$HOME/.local/bin/hue" all chill
