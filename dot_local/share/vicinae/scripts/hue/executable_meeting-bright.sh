...
# @vicinae.title Hue Couch Meeting: Bright
# @vicinae.mode silent
# @vicinae.packageName Hue
# @vicinae.icon 🔆
# @vicinae.keywords ["meeting bright", "hue"]
# @vicinae.description Recall the "Bright" scene for Couch Meeting.

exec "$HOME/.local/bin/hue" meeting bright
