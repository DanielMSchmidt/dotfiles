...
# @vicinae.title Hue Office (Arbeitszimmer): Chill
# @vicinae.mode silent
# @vicinae.packageName Hue
# @vicinae.icon 🌙
# @vicinae.keywords ["office chill", "hue"]
# @vicinae.description Recall the "Chill" scene for Office (Arbeitszimmer).

exec "$HOME/.local/bin/hue" office chill
