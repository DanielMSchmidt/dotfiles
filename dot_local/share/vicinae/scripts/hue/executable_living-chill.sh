...
# @vicinae.title Hue Living Room (Wohnzimmer): Chill
# @vicinae.mode silent
# @vicinae.packageName Hue
# @vicinae.icon 🌙
# @vicinae.keywords ["living chill", "hue"]
# @vicinae.description Recall the "Chill" scene for Living Room (Wohnzimmer).

exec "$HOME/.local/bin/hue" living chill
