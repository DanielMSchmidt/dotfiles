...
# @vicinae.title Hue Office (Arbeitszimmer): Bright
# @vicinae.mode silent
# @vicinae.packageName Hue
# @vicinae.icon 🔆
# @vicinae.keywords ["office bright", "hue"]
# @vicinae.description Recall the "Bright" scene for Office (Arbeitszimmer).

exec "$HOME/.local/bin/hue" office bright
