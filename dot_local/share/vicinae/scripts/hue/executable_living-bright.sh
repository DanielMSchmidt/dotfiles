...
# @vicinae.title Hue Living Room (Wohnzimmer): Bright
# @vicinae.mode silent
# @vicinae.packageName Hue
# @vicinae.icon 🔆
# @vicinae.keywords ["living bright", "hue"]
# @vicinae.description Recall the "Bright" scene for Living Room (Wohnzimmer).

exec "$HOME/.local/bin/hue" living bright
