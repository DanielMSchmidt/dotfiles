...
# @vicinae.title Hue Couch: Bright
# @vicinae.mode silent
# @vicinae.packageName Hue
# @vicinae.icon 🔆
# @vicinae.keywords ["couch bright", "hue"]
# @vicinae.description Recall the "Bright" scene for Couch.

exec "$HOME/.local/bin/hue" couch bright
