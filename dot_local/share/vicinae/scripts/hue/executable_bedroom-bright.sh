...
# @vicinae.title Hue Bedroom (Schlafzimmer): Bright
# @vicinae.mode silent
# @vicinae.packageName Hue
# @vicinae.icon 🔆
# @vicinae.keywords ["bedroom bright", "hue"]
# @vicinae.description Recall the "Bright" scene for Bedroom (Schlafzimmer).

exec "$HOME/.local/bin/hue" bedroom bright
